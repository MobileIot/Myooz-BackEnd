...
const {fetchNoteHandler, fetchAllNotesHandler, createNoteHandler, updateNoteHandler, deleteNoteHandler} = require("./endpoints/notes.js");
...
server.del("/notes/:note_id", deleteNoteHandler(serverState));
